...
#line 15 ""
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
	{
		...
		o.Albedo = dot(IN.worldNormal, IN.viewDir) < -0.075 ? _Color : c.rgb;
...
#define FOG_COMBINED_WITH_WORLD_POS
	...
	//if (dot(normalize(UnityWorldSpaceViewDir(worldPos)), normalize(o.Normal)) < -0.1)
